...
export default function LiveSignalsFull() {
  return (
        ...
        <div className="mx-auto flex max-w-[90rem] items-center justify-between px-4 py-3 sm:px-6">
          <div className="flex items-center gap-4">
            <Link to="/" className="text-xl font-bold tracking-tight text-white flex items-center gap-2">
              ⚡ <span className="bg-gradient-to-r from-emerald-400 to-sky-400 bg-clip-text text-transparent">INTRADAY SIGNALS</span>
            </Link>
